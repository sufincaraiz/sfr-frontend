    ...
    return (
      <div style={{ textAlign: 'center', padding: '2.5rem 1.5rem' }}>
        ...
        <p style={{ color: '#475569', fontSize: '0.95rem', lineHeight: 1.6, maxWidth: 360, margin: '0 auto' }}>
          Un asesor te contactará en menos de 24 horas para coordinar la valoración de tu propiedad.
        </p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      <div>
        ...
        <input
          id="nombre" type="text" value={form.nombre} onChange={update('nombre')}
      ...
      <div>
        <label style={labelStyle} htmlFor="telefono">Celular / WhatsApp *</label>
        <input
          id="telefono" type="tel" value={form.telefono} onChange={update('telefono')}
      ...
      <div>
        <label style={labelStyle} htmlFor="mensaje">Descripción de tu propiedad</label>
        <textarea
          id="mensaje" value={form.mensaje} onChange={update('mensaje')}
          placeholder="Ubicación (municipio, vereda), extensión y detalles de tu finca, lote o casa campestre."
          rows={4}
      ...
      >
        <Send size={17} /> {status === 'loading' ? 'Enviando…' : 'Quiero vender mi propiedad'}
      </button>
