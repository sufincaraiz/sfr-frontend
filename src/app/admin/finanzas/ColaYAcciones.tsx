...
import { CloudOff, Loader2, Plus, UploadCloud } from 'lucide-react';
import {
  almacenNavegador, avisoDeCola, leerCola, vaciarCola, type PendienteEnCola,
...
export default function ColaYAcciones() {
  ...
  useEffect(() => {
    refrescar();
    subir();
    const alVolver = () => { refrescar(); subir(); };
