...
export async function GET() {
  ...
  const lineas: string[] = [
    ...
    `> ${listaTipos} para vivienda, recreo e inversión, en suelo rural y en el`,
    `> casco urbano de los municipios donde opera.`,
    `> Trabaja en consorcio con Conarc (construcción) y acompaña la debida`,
    `> diligencia inmobiliaria —títulos, uso del suelo, acceso y agua— orientando`,
    `> al comprador sobre qué revisar antes de firmar.`,
    ``,
    ...
    `## Qué hacemos`,
    ``,
    `El servicio principal es el corretaje: venta e intermediación de inmuebles rurales`,
    `y urbanos —${listaTipos}—, con el inventario publicado y actualizado en el catálogo`,
    `del sitio. En cada negociación acompañamos la debida diligencia inmobiliaria:`,
    `orientamos al comprador sobre qué revisar —títulos, uso del suelo y PBOT, acceso`,
    `y agua— y estamos presentes en la notaría hasta la escrituración.`,
    ``,
